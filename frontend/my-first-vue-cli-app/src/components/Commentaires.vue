    ...
    <div>
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-10 col-lg-8">
                    <a data-toggle="modal" data-target="#modalAddComment" class="my-2 btn btn-sm btn-block btn-success">Poster un commentaire...</a>
                    <!-- TEST NON CONCLUANT POUR LA VISUALISATION DES MODALS -->
                                ...
                                <form enctype="multipart/form-data">
                                    ...
                                    <div class="row modal-body">
                                        <div class="col-12 justify-content-center form-group">
                                            ...
                                            <textarea class="form-control" v-model="newComment" id="newComment" name="comment" rows="3" placeholder="Votre commentaire ici..." required :class="{ 'is-invalid': submitted && !newComment }"></textarea>
...
export default {
    ...
    created: function () {
        ...
        axios.get("http://127.0.0.1:3000/api/comments/all/" + this.$route.params.id, { headers: {"Authorization": "Bearer " + localStorage.getItem("token")} })
