...
exports.findAllOneComments = (req, res, next) => {
    Comment.findAll({
        where: { 
...
exports.deleteComment = (req, res, next) => {
    ...
    console.log(" comment Uid is : " + req.params.commentUid)
    console.log(" currentUid who ask the deletion is : " + req.params.currentUid)
